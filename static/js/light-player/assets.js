...
shakaAssets.UplynkRequestFilter = function(type, request) {
  ...
  if (type == shaka.net.NetworkingEngine.RequestType.LICENSE) {
    ...
    if (request.uris[0].indexOf("wv") !== -1 && shakaAssets.uplynk_prefix) {
      request.uris[0] = shakaAssets.uplynk_prefix.concat("/wv");
    } else if (
      request.uris[0].indexOf("ck") !== -1 &&
      shakaAssets.uplynk_prefix
    ) {
      request.uris[0] = shakaAssets.uplynk_prefix.concat("/ck");
    } else if (
      request.uris[0].indexOf("pr") !== -1 &&
      shakaAssets.uplynk_prefix
    ) {
...
shakaAssets.testAssets = [
  // Shaka assets {{{
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/angel-one/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/angel-one-widevine/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/angel-one-clearkey/dash.mpd", // eslint-disable-line max-len
    ...
    licenseServers: {
      "org.w3.clearkey":
        "//cwip-shaka-proxy.appspot.com/clearkey?_u3wDe7erb7v8Lqt8A3QDQ=ABEiM0RVZneImaq7zN3u_w" // eslint-disable-line max-len
    }
  },
  {
    name: "Angel One (HLS, MP4, multilingual)",
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/angel-one-hls/hls.m3u8", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/angel-one-widevine-hls/hls.m3u8", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/sintel-trickplay/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/sintel-webm-only/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/sintel-mp4-only/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/sintel-widevine/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/sintel-mp4-wvtt/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/heliocentrism/heliocentrism.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/heliocentrism-xlink/heliocentrism.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/dig-the-uke-clear/dash.mpd", // eslint-disable-line max-len
  ...
  {
    name:
      '"Dig the Uke" by Stefan Kartenberg (audio only, multicodec, Widevine)', // eslint-disable-line max-len
    // From: http://dig.ccmixter.org/files/JeffSpeed68/53327
    // Licensed under Creative Commons BY-NC 3.0.
    // Free for non-commercial use with attribution.
    // http://creativecommons.org/licenses/by-nc/3.0/
    manifestUri:
      "//storage.googleapis.com/shaka-demo-assets/dig-the-uke/dash.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//storage.googleapis.com/shaka-live-assets/player-source.m3u8", // eslint-disable-line max-len
    encoder: shakaAssets.Encoder.SHAKA_PACKAGER,
    source: shakaAssets.Source.SHAKA,
    drm: [],
    features: [
  ...
  // Src: https://github.com/Axinom/dash-test-vectors
  {
    name: "Multi-DRM",
    manifestUri:
      "//media.axprod.net/TestVectors/v7-MultiDRM-SingleKey/Manifest.mpd", // eslint-disable-line max-len

    encoder: shakaAssets.Encoder.AXINOM,
    source: shakaAssets.Source.AXINOM,
    drm: [shakaAssets.KeySystem.PLAYREADY, shakaAssets.KeySystem.WIDEVINE],
    features: [
      shakaAssets.Feature.EMBEDDED_TEXT,
      shakaAssets.Feature.HIGH_DEFINITION,
      shakaAssets.Feature.MP4,
    ...
    licenseServers: {
      "com.widevine.alpha":
        "//drm-widevine-licensing.axtest.net/AcquireLicense", // eslint-disable-line max-len
      "com.microsoft.playready":
        "//drm-playready-licensing.axtest.net/AcquireLicense" // eslint-disable-line max-len
    },
  ...
  },
  {
    ...
    manifestUri:
      "//media.axprod.net/TestVectors/v7-MultiDRM-MultiKey/Manifest.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//media.axprod.net/TestVectors/v7-MultiDRM-MultiKey-MultiPeriod/Manifest.mpd", // eslint-disable-line max-len
    ...
    licenseRequestHeaders: {
      "X-AxDRM-Message":
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BXr93Et1krYMVs-CUnf7F3ywJWFRtxYdkR7Qn4w3-to" // eslint-disable-line max-len
    }
  },
  {
  ...
  },
  {
    ...
    manifestUri:
      "//media.axprod.net/TestVectors/v7-Clear/Manifest_MultiPeriod.mpd", // eslint-disable-line max-len
  ...
  // Src: http://demo.unified-streaming.com/features.html
  {
    name: "Tears of Steel",
    manifestUri:
      "//demo.unified-streaming.com/video/tears-of-steel/tears-of-steel.ism/.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//demo.unified-streaming.com/video/tears-of-steel/tears-of-steel-dash-widevine.ism/.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//demo.unified-streaming.com/video/tears-of-steel/tears-of-steel-dash-playready.ism/.mpd", // eslint-disable-line max-len
    ...
    licenseServers: {
      "com.microsoft.playready":
        "//test.playready.microsoft.com/service/rightsmanager.asmx?PlayRight=1&UseSimpleNonPersistentLicense=1" // eslint-disable-line max-len
    }
  },
  {
    name: "Tears of Steel (subtitles)",
    manifestUri:
      "//demo.unified-streaming.com/video/tears-of-steel/tears-of-steel-ru.ism/.mpd", // eslint-disable-line max-len
  ...
  // Src: http://dashif.org/test-vectors/
  {
    name: "Big Buck Bunny",
    manifestUri:
      "//dash.edgesuite.net/dash264/TestCases/1c/qualcomm/2/MultiRate.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//vm2.dashif.org/livesim/utc_head/periods_20/testpic_2s/Manifest.mpd", // eslint-disable-line max-len
  ...
  // Src: http://www.dash-player.com/demo/streaming-server-and-encoder-support/
  {
    ...
    manifestUri:
      "//wowzaec2demo.streamlock.net/live/bigbuckbunny/manifest_mpm4sav_mvtime.mpd", // eslint-disable-line max-len
  ...
  // Src: https://bitmovin.com/mpeg-dash-hls-examples-sample-streams/
  {
    ...
    manifestUri:
      "//bitdash-a.akamaihd.net/content/MI201109210084_1/mpds/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//bitdash-a.akamaihd.net/content/MI201109210084_1/m3u8s/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.m3u8", // eslint-disable-line max-len
  ...
  // Src: http://www.dash-player.com/demo/streaming-server-and-encoder-support/
  {
    name: "Big Buck Bunny",
    manifestUri:
      "//video.wmspanel.com/local/raw/BigBuckBunny_320x180.mp4/manifest.mpd", // eslint-disable-line max-len
  ...
  // Src: http://amp.azure.net/libs/amp/latest/docs/samples.html
  {
    name: "Azure Trailer",
    manifestUri:
      "//amssamples.streaming.mediaservices.windows.net/91492735-c523-432b-ba01-faba6c2206a2/AzureMediaServicesPromo.ism/manifest(format=mpd-time-csf)", // eslint-disable-line max-len
  ...
  },
  {
    name: "Big Buck Bunny",
    manifestUri:
      "//amssamples.streaming.mediaservices.windows.net/622b189f-ec39-43f2-93a2-201ac4e31ce1/BigBuckBunny.ism/manifest(format=mpd-time-csf)", // eslint-disable-line max-len
    ...
    licenseServers: {
      "com.widevine.alpha":
        "//amssamples.keydelivery.mediaservices.windows.net/Widevine/?KID=1ab45440-532c-4399-94dc-5c5ad9584bac", // eslint-disable-line max-len
      "com.microsoft.playready":
        "//amssamples.keydelivery.mediaservices.windows.net/PlayReady/" // eslint-disable-line max-len
    }
  },
  {
    name: "Tears Of Steel (external text)",
    manifestUri:
      "//ams-samplescdn.streaming.mediaservices.windows.net/11196e3d-2f40-4835-9a4d-fc52751b0323/TearsOfSteel_WAMEH264SmoothStreaming720p.ism/manifest(format=mpd-time-csf)", // eslint-disable-line max-len
    extraText: [
      {
        uri:
          "//ams-samplescdn.streaming.mediaservices.windows.net/11196e3d-2f40-4835-9a4d-fc52751b0323/TOS-en.vtt", // eslint-disable-line max-len
        language: "en",
        kind: "subtitle",
        mime: "text/vtt"
      },
      {
        uri:
          "//ams-samplescdn.streaming.mediaservices.windows.net/11196e3d-2f40-4835-9a4d-fc52751b0323/TOS-es.vtt", // eslint-disable-line max-len
        language: "es",
        kind: "subtitle",
        mime: "text/vtt"
      },
      {
        uri:
          "//ams-samplescdn.streaming.mediaservices.windows.net/11196e3d-2f40-4835-9a4d-fc52751b0323/TOS-fr.vtt", // eslint-disable-line max-len
        language: "fr",
        kind: "subtitle",
        mime: "text/vtt"
      }
  ...
  // "live streams".  The content is still static, as is the timeline.
  {
    name: "live profile",
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-live/mp4-live-mpd-AV-BS.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-live-periods/mp4-live-periods-mpd.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-main-single/mp4-main-single-mpd-AV-NBS.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-main-multi/mp4-main-multi-mpd-AV-BS.mpd", // eslint-disable-line max-len
    // NOTE: Multiple SPS/PPS in init segment, no sample duration
    // NOTE: Decoder errors on Mac
    // https://github.com/gpac/gpac/issues/600
    // https://bugs.webkit.org/show_bug.cgi?id=160459
  ...
  },
  {
    ...
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-onDemand/mp4-onDemand-mpd-AV.mpd", // eslint-disable-line max-len

    encoder: shakaAssets.Encoder.MP4BOX,
    source: shakaAssets.Source.GPAC,
    drm: [],
    features: [shakaAssets.Feature.MP4, shakaAssets.Feature.SEGMENT_BASE]
  },
  {
    name: "main profile, open GOP",
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-main-ogop/mp4-main-ogop-mpd-AV-BS.mpd", // eslint-disable-line max-len
  ...
  },
  {
    ...
    manifestUri:
      "//download.tsi.telecom-paristech.fr/gpac/DASH_CONFORMANCE/TelecomParisTech/mp4-full-gdr/mp4-full-gdr-mpd-AV-BS.mpd", // eslint-disable-line max-len
    // NOTE: segments do not start with keyframes
    // NOTE: Decoder errors on Safari
    // https://bugs.webkit.org/show_bug.cgi?id=160460
    disabled: true,
  ...
  // Verizon Digital Media Services (VDMS) assets {{{
  {
    ...
    manifestUri:
      "https://content.uplynk.com/847859273a4b4a81959d8fea181672a4.mpd?pr.version=2&pr.playenabler=B621D91F-EDCC-4035-8D4B-DC71760D43E9&pr.securitylevel=150", // eslint-disable-line max-len
  ...
  },
  {
    ...
    // The playenabler and sl url parameters allow for playback in VMs
    manifestUri:
      "https://content.uplynk.com/054225d59be2454fabdca3e96912d847.mpd?ad=cleardash&pr.version=2&pr.playenabler=B621D91F-EDCC-4035-8D4B-DC71760D43E9&pr.securitylevel=150", // eslint-disable-line max-len
    encoder: shakaAssets.Encoder.UPLYNK,
    source: shakaAssets.Source.UPLYNK,
    drm: [shakaAssets.KeySystem.PLAYREADY, shakaAssets.KeySystem.WIDEVINE],
    features: [
  ...
  },
  {
    ...
    manifestUri:
      "https://content.uplynk.com/224ac8717e714b68831997ab6cea4015.mpd", // eslint-disable-line max-len
    encoder: shakaAssets.Encoder.UPLYNK,
    source: shakaAssets.Source.UPLYNK,
    drm: [shakaAssets.KeySystem.WIDEVINE],
    features: [
  ...
  },
  {
    ...
    manifestUri:
      "https://content.uplynk.com/1eb40d8e64234f5c9879db7045c3d48c.mpd?ad=cleardash&rays=cdefg", // eslint-disable-line max-len
