class InfiniteScroll{
    setup(scrollElem,scrollContent,batchLength,addMoreCallback){
        ...
        this.addMore = function(results, initial = false){
            ...
            if(((scrollElem.scrollTop() + scrollElem.height()) > (scrollContent.height() - self.preloadSize)) && (initial || results > 0) 
             || self.agentID && (scrollElem.scrollTop() + scrollElem.height()) + 150 > scrollContent.height() - self.preloadSize){
