class UsersController{
    ...
    render(div){
        ...
        $("#addUserButton").click(function(){
            ...
            postAsJson(data,"/users", function(response){
                $.getJSON( "users", function( users ) {
                    self.renderUsers(users);
                });
            },function(response){
    ...
    renderUser(user){
        ...
        template.find(".remove_user_btn").click(function(){
            var r = confirm("You will remove the user "+user.username+" with id "+user.id);
            if(r){
                deleteReq("/users/"+encodeURIComponent(id),
                function(success){
                    template.remove()
                },
                function(err){
        ...
        template.find(".update_user_btn").click(function(){
            ...
            postAsJson(data,"/users/"+id, function(response){
                $.getJSON( "users", function( users ) {
                    self.renderUsers(users);
                });
            },function(response){
