class ContentManager {
  constructor() {
    ...
    this.moviesMgr = new MoviesContent(
      this.templates,
    ...
    this.workersMgr = new WorkerController(
      this.templates,
      this.sharedWebsocket
    );
    this.mediaContentMgr = new MediaContentController(
      this.templates,
      this.sharedWebsocket
    );
    this.transcodingMgr = new TranscodingController(
      this.templates,
      this.sharedWebsocket
    );
  ...
  loadTemplates(onSuccess) {
    ...
    $.when(
      ...
      $.get("storage.html"),
      $.get("settings.html")
    ).done(function(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) {
      var templates = {};
  ...
  start() {
    ...
    this.mainGuiElements.mainSearch = new BufferedSearchElement(
      $("#main_search"),
      function(text) {
