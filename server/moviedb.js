...
var moviedb = new Moviedb('f26a12bc09fb5340574cdad2e5947fc5');

// The class TMDB is used to respect the TheMovieDatabase api limit to 4 request per seconds
class TMDB{
    constructor(moviedb,max_req=40,req_time=10){
    ...
    getSerieById(movieDBId,successCB,errorCB){

        for(var i=0; i<this.langs.length; i++){
            this.theMovieDb.common.language = this.langs[i];
            this.theMovieDb.tv.getById({"id":movieDBId}, successCB, errorCB);

        }
    }

    // constructor(theMovieDb,max_req=40,req_time=10){
...
//module.exports=new TMDB(theMovieDb);
